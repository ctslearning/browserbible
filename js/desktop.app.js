				...
				docs.Search = (function() {
					...
					function doSearch() {
						...
						bible.BibleSearch.search( input, version,
							...
							// found
              function(resultHtml) {
                searchWindow.content.append(resultHtml);
                // jQuery('#search .popup-content').scrollTo(jQuery('#search .popup-content .search-result:last-child'));
                // jQuery('#search .popup-content').scrollTop(jQuery('#search .popup-content .search-result:last-child').offset().top);
              },
							// ended
